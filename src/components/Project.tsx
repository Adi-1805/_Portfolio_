    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            ...
            <div className="project">
                ...
                <p>A production-ready RAG chatbot built with LangGraph, Streamlit, and Pinecone. Upload documents and get intelligent insights through an interactive chat interface. Implementing features like isolated sessions, Docker deployment, logging, error handling, and LangSmith tracing for scalable, maintainable performance.</p>
            </div>
            <div className="project">
            ...
            <div className="project">
                <a href="https://github.com/Adi-1805/Audio-Recognition-using-Deep-Learning" target="_blank" rel="noreferrer"><img src={mock00} className="zoom" alt="thumbnail" width="100%"/></a>
                <a href="https://github.com/Adi-1805/Audio-Recognition-using-Deep-Learning" target="_blank" rel="noreferrer"><h2>Coffee Sales Dashboard</h2></a>
                <p>Built a dashboard to analyze coffee sales data and identify trends and patterns in coffee sales data using Power Pivot and Power BI.</p>   
            </div>
        </div>
    </div>
    );
